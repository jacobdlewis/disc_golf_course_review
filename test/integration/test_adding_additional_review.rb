...
class TestAddingAdditionalReview < Minitest::Test

  def test_adding_additional_review_happy_path
    shell_output = ""
    expected_output = ""
    IO.popen('./disc_golf_course_tracker', 'r+') do |pipe|
      ...
      pipe.puts "Token Creek"
      expected_output << "Please add a brief review for Token Creek.\n"
  ...
  def test_adding_additional_review_sad_path
    shell_output = ""
    expected_output = ""
    IO.popen('./disc_golf_course_tracker', 'r+') do |pipe|
      expected_output << main_menu
      ...
      expected_output << "What is the name of the course you want to review?\n"
      pipe.puts ""
      expected_output << "Please add a brief review for .\n"
      pipe.puts ""
