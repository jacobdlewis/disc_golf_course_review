...
class TestListingMultipleCourseReviews < Minitest::Test

  def test_listing_multiple_reviews_sad_path
    shell_output = ""
    expected_output = ""
  ...
  def test_listing_multiple_reviews_happy_path
    shell_output = ""
    expected_output = ""
    IO.popen('./disc_golf_course_tracker', 'r+') do |pipe|
      expected_output << main_menu
